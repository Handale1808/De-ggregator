...
const extractFromPage = () => {
  const SUPPORTED = [
    'news.yahoo.com', 'www.yahoo.com', 'yahoo.com',
    'www.msn.com', 'msn.com',
    'news.google.com',
    'www.bing.com', 'bing.com',
    'www.aol.com', 'aol.com',
    'www.newsbreak.com', 'newsbreak.com',
    'ground.news', 'www.ground.news',
    'www.newsnow.co.uk', 'newsnow.co.uk',
  ]
  ...
  if (!headline) headline = document.querySelector('h2')?.textContent?.trim() ?? ''
  if (!headline) headline = document.title?.trim() ?? ''
  ...
  const aggregatorNames = ['yahoo', 'msn', 'google news', 'bing', 'aol', 'newsbreak', 'ground news', 'newsnow']
